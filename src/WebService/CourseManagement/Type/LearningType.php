...
class LearningType
{
    ...
    private ?AccreditationDetails $AccreditationDetails = null;

    private ?ArrayOfReference $References = null;

    private bool $IsShared;

    private ?string $ExclusionMode = null;

    private ?string $LeaningPathActivityLayout = null;

    private ?string $ShowLearnerProgressAs = null;
    ...
    private ?string $VideoCompleteOnTime_Minute = null;
    ...
    private ?string $LastEnrollmentBasedFirstEnrollmentDateSetting = null;
    ...
    private ?string $SupervisorExtensionDaysLimitStartFrom = null;
    ...
    private ?string $SuspendAccessDays = null;
    ...
    private ?ArrayOfAnyType $AutoenrollRules = null;

    private bool $AutoenrollRulesRequired;

    private ?string $AutoenrollRepeatType = null;

    private ?string $AutoenrollRepeatMonthCount = null;

    private DateTimeInterface $AutoenrollLastRunDate;

    private ?ArrayOfAnyType $AutoenrollExcludeRules = null;
    ...
    private ?ArrayOfAnyType $RecertificationAutoEnrollRules = null;

    private ?ArrayOfAnyType $RecertificationAutoEnrollExcludeRules = null;

    private bool $ReAutoEnrollmentAllowAll;

    private ?string $ReAutoenrollRepeatType = null;

    private ?string $ReAutoenrollRepeatMonthCount = null;
    ...
    private ?string $EnrollPermissionFrom = null;
    ...
    private ?ArrayOfAnyType $SelfEnrollRules = null;

    private ?ArrayOfAnyType $SelfEnrollGroups = null;

    private bool $SelfEnrollGroupRequired;

    private bool $SelfEnrollRulesRequired;

    private ?ArrayOfAnyType $SelfEnrollExcludeRules = null;
    ...
    private ?string $UnenrollOption = null;

    private ?string $UnenrollPermissionFrom = null;

    private ?ArrayOfAnyType $WithdrawalRules = null;

    private bool $WithdrawalRulesRequired;

    private ?ArrayOfAnyType $WithdrawalExcludeRules = null;
    ...
    private ?ArrayOfAnyType $AutoWithdrawalRules = null;

    private bool $AutoWithdrawalRulesRequired;

    private ?ArrayOfAnyType $AutoWithdrawalExcludeRules = null;

    private bool $AutoWithdrawalExcludeRulesRequired;

    private ?ArrayOfAnyType $AnnouncementRules = null;

    private bool $AnnouncementRulesRequired;

    private ?ArrayOfAnyType $AnnouncementExcludeRules = null;
    ...
    private ?string $DisclaimerTextButton = null;
    ...
    private ?string $InitialScormVersion = null;
    ...
    private bool $SendfeedbackReminderNotification;
    ...
    private ?string $OpenCourseIn = null;
    ...
    private ?string $AzureRunMode = null;

    private bool $DynamicProgram;

    private float $LearningTime;

    private float $MinLearningTime;

    private float $MaxLearningTime;

    private ?string $EditorXML = null;

    private ?string $TranscriptPrintMode = null;
    ...
    private ?string $CustomScoreFeedbackXml = null;

    private ?string $CustomActivityTypeID = null;
    ...
    private ?ArrayOfAnyType $Assessments = null;
    ...
    public function getSendfeedbackReminderNotification(): bool
    {
        return $this->SendfeedbackReminderNotification;
    }

    public function withSendfeedbackReminderNotification(bool $SendfeedbackReminderNotification): static
    {
        $new = clone $this;
        $new->SendfeedbackReminderNotification = $SendfeedbackReminderNotification;
    ...
    public function getMinLearningTime(): float
    {
        return $this->MinLearningTime;
    }

    public function withMinLearningTime(float $MinLearningTime): static
    {
        $new = clone $this;
        $new->MinLearningTime = $MinLearningTime;

        return $new;
    }

    public function getMaxLearningTime(): float
    {
        return $this->MaxLearningTime;
    }

    public function withMaxLearningTime(float $MaxLearningTime): static
    {
        $new = clone $this;
        $new->MaxLearningTime = $MaxLearningTime;
