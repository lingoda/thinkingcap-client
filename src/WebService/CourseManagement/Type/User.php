...
class User
{
    ...
    private ?string $HomeDomainName = null;

    private ?ArrayOfDomainURLsCollection $BaseURLs = null;

    private ?string $FirstName = null;

    private DateTimeInterface $LastLoginDate;

    private ?string $LastLoginBrowser = null;

    private ?string $LastLoginDevice = null;
    ...
    private ?string $SyncDomain = null;
    ...
    private ?string $OutsideEmail = null;

    private bool $NewsLetterEmailOptOutDisabled;

    private ?ArrayOfMail $Mails = null;

    private ?ArrayOfMailFolder $PersonalFolders = null;

    private ?ArrayOfContact $Contacts = null;

    private ?ArrayOfRole $Roles = null;

    private ?ArrayOfPermission $Permissions = null;

    private bool $BlockNotifications;

    private ?string $BlockNotificationsReason = null;

    private bool $BlockDomainAnnouncements;

    private ?ArrayOfProgram $Programs = null;

    private bool $ProgramMgr;

    private ?ArrayOfCourse $Courses = null;

    private ?ArrayOfString $CourseTitles = null;

    private ?ArrayOfCourse $ActivityMaps = null;

    private ?ArrayOfString $ActivityMapTitles = null;

    private ?Course $CurrentCourse = null;

    private ?ArrayOfCourse $TACourses = null;

    private ?ArrayOfString $TACourseTitles = null;

    private ?ArrayOfCourse $TAActivityMaps = null;

    private ?ArrayOfString $TAActivityMapTitles = null;
    ...
    public function getRO(): bool
    {
        return $this->RO;
    }

    public function withRO(bool $RO): static
    {
        $new = clone $this;
        $new->RO = $RO;
    ...
    public function withIsReadOnly(bool $IsReadOnly): static
    {
        $new = clone $this;
    ...
    public function withIsGuest(bool $IsGuest): static
    {
        $new = clone $this;
        $new->IsGuest = $IsGuest;
